...
public class OrderBookTest {
    ...
    public void shouldAddToOrderBookWithAGivenOrder() {
        ...
        Order order = new Order(Side.BID, 77.2, 1000000);
    ...
    public void shouldReturnPriceOfThePositionOfLadderWithSideAndLevel() {
        OrderBook orderBook = new OrderBook();
        Order order = new Order(Side.BID, 77.1, 1000000);
        orderBook.addOrder(order);
        orderBook.addOrder(new Order(Side.BID, 77.0, 2000000));
        orderBook.addOrder(new Order(Side.OFFER, 77.5, 2000000));
        orderBook.addOrder(new Order(Side.BID, 77.2, 3000000));
        orderBook.addOrder(new Order(Side.BID, 76.9, 3000000));
    ...
    public void shouldReturnTotalQuantityWithSideAndLevel() {
        OrderBook orderBook = new OrderBook();
        orderBook.addOrder(new Order(Side.BID, 77.2, 3000000));
        Order order1 = new Order(Side.BID, 77.1, 1000000);
        Order order2 = new Order(Side.BID, 77.1, 3000000);
